...
public class Constants
{
    ...
    public static final int REGISTRATION_FORM_CONTROLLER_BASE = 2100;
    public static final int REGISTRATION_FORM_CONTROLLER_GET_FORM = REGISTRATION_FORM_CONTROLLER_BASE + 1;
    public static final int REGISTRATION_FORM_CONTROLLER_SUBMIT_FORM = REGISTRATION_FORM_CONTROLLER_BASE + 2;

    public static final int COURSE_CONTROLLER_BASE = 2200;
    public static final int COURSE_CONTROLLER_FIND_COURSES = COURSE_CONTROLLER_BASE + 1;
}
