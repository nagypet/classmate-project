...
@ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "409", description = "The email address is already taken", content = @Content(schema = @Schema(implementation = RestExceptionResponse.class))),
...
public @interface StandardApiResponses201_400_401_403_409_500
{
}
