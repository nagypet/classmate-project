...
import hu.perit.classmate.db.classmate.ClassMateDbConfig;
 ...
 * @author nagy_peter
 */
@Repository(value = "NativeQueryRepo")
@Generated // To disable counting in unit test coverage
public class NativeQueryRepo
{
    private final NativeQueryRepoImpl impl;

    public NativeQueryRepo(@Qualifier(value = ClassMateDbConfig.ENTITY_MANAGER_FACTORY) EntityManager em, DatasourceCollectionProperties dbProperties)
    {
        DatasourceProperties datasourceProperties = dbProperties.getDatasource().get(ClassMateDbConfig.PERSISTENCE_UNIT);
