...
package hu.perit.classmate.db.classmate;
...
@EnableJpaRepositories(basePackages = ClassMateDbConfig.PACKAGES,
        entityManagerFactoryRef = ClassMateDbConfig.ENTITY_MANAGER_FACTORY,
        transactionManagerRef = ClassMateDbConfig.TRANSACTION_MANAGER)
@Slf4j
@EnableJpaAuditing(auditorAwareRef = "auditorProvider")
@Generated // To disable counting in unit test coverage
public class ClassMateDbConfig
{
    static final String PACKAGES = "hu.perit.classmate.db.classmate";
    public static final String ENTITY_MANAGER_FACTORY = "entityManagerFactory";
    static final String TRANSACTION_MANAGER = "transactionManager";

    public static final String PERSISTENCE_UNIT = "classmate";
    private static final String DATASOURCE = "dataSource";

    private final ConnectionParam connectionParam;


    public ClassMateDbConfig(DatasourceCollectionProperties dbProperties)
    {
